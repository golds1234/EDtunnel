...
const proxyIPs = ['128.199.86.153','139.59.106.149'];

let proxyIP = proxyIPs[Math.floor(Math.random() * proxyIPs.length)];

let dohURL = 'https://dns.nextdns.io/a55f28'; // https://cloudflare-dns.com/dns-query or https://dns.google/dns-query
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						const hostnames = ['www.bing.com', 'www.google.com'];
